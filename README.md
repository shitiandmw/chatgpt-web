...
> 声明：此项目是在ChatGPT-Web项目基础上，增加了一些功能
...
# 后台运行
docker run \
--name chat-main -d -p 23002:3002 \
--env OPENAI_API_KEY=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 \
--log-driver json-file  \
--log-opt max-size=100m  \
--log-opt max-file=2  \
--restart=always \
--net demo --ip 172.20.0.11 \
ccr.ccs.tencentyun.com/luxiangqun_work/chat-main:1.0
