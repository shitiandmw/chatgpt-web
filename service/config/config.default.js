...
module.exports = appInfo => {
  ...
  // const db_ip = "175.178.243.97";
  const db_ip = "192.168.1.26";
  // config.mongoose = {
  //   client: {
  //     // 使用root用户名连接egg_chat数据库，认证库为admin
  //     url: `mongodb://192.168.8.105:18001/egg_chat?authSource=admin`,
  //     options: {
  //       user: 'dbroot',
  ...
  config.mongoose = {
    client: {
      // 使用root用户名连接egg_chat数据库，认证库为admin
      url: `mongodb://${db_ip}:18001/egg_chat?authSource=admin`,
      options: {
        user: 'db_root',
